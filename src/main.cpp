...
int main()
{
    ...
    version:
        ...
        Minor = {}
        Build = {}
)", Testify::test.getId(), Testify::test(),
      versionTest.major, versionTest.minor, versionTest.build);
    ...
    version:
        ...
        Minor = {}
        Build = {}
)", test4.getId(), test4Value.value, test4Value.raw,
      version4Test.major, version4Test.minor, version4Test.build);
